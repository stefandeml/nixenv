{ vimUtils, fetchFromGitHub }:
{
  ...
  tiler = vimUtils.buildVimPluginFrom2Nix {
    name = "tiler-2021-04-18";
    src = fetchFromGitHub {
      owner = "wsdjeg";
      repo = "tiler.vim";
      rev = "07f2d0c7c1dd8762f406e8f59c9c540963a3ab9e";
      sha256 = "0ps0friwzr9smvymjvgzkvrlyljw6v45wn3axn8b874isifpfch2";
    };
    dependencies = [];
  };
